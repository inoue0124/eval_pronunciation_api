...
export const Filter = function () {
  ...
  this.transform = function (nsection, fp, f1, f2, ftype) {
  ...
  this.design = function (ftype, forder, flow, fhigh, fsamp) {
  ...
  this.resonator = function (cf, bw, fsamp) {
    var wf, wb, r, gain
  ...
  /* build a vocal tract */
  this.vocaltract = function (f1, f2, f3, fsamp) {
    var i
    var wf, wb, r, gain
  ...
  this.process = function (signal) {
    ...
    this.clear()
    for (i = 0; i < signal.length; i++) osignal[i] = this.sample(signal[i])
    return osignal
  }

  /* complex multiply */
  this.CMLT = function (a, b) {
    var t = new Complex()
  ...
  this.response = function (f, fsamp) {
    var i, j
    var omega
    var gain
    var wj = new Array(5)
